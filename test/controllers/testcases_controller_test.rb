...
class TestcasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create testcase" do
    assert_difference('Testcase.count') do
      post testcases_url, params: { testcase: { description: @testcase.description, name: @testcase.name, string: @testcase.string } }, as: :json
    end
  ...
  test "should update testcase" do
    patch testcase_url(@testcase), params: { testcase: { description: @testcase.description, name: @testcase.name, string: @testcase.string } }, as: :json
    assert_response 200
  end
